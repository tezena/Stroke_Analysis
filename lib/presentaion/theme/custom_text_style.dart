...
class CustomTextStyles {
  ...
  static get titleLargePoppinsBlack900 =>
      ...
      static get titleSmallBlack900Medium2 => theme.textTheme.titleSmall!.copyWith(
        color: appTheme.black900,
  ...
  static get bodySmallGray2700 => theme.textTheme.bodySmall!.copyWith(
        color: appTheme.gray700,
        fontSize: 12.fSize,
      );
       static get titleSmall2Black900 => theme.textTheme.titleSmall!.copyWith(
        color: appTheme.black900,
        fontWeight: FontWeight.w700,
      );
